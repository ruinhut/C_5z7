...
int main(){
    ...
    arrayForInnerBoardLayout[1][2] = 1;
    arrayForInnerBoardLayout[1][3] = 1;
    arrayForInnerBoardLayout[2][1] = 1;
    arrayForInnerBoardLayout[2][4] = 1;
    arrayForInnerBoardLayout[3][1] = 1;
    arrayForInnerBoardLayout[3][4] = 1;
    arrayForInnerBoardLayout[4][2] = 1;
    arrayForInnerBoardLayout[4][3] = 1;
    for(i=0;i<SIZE;i++){
        for(j = 0; j < SIZE ; j++){
    ...
    findMax(1,robotScoreBoard,enemyScoreBoard,mytop3);
    printf("%d,%d,%d\n",mytop3[0][0],mytop3[0][1],mytop3[0][2]);
    printf("%d,%d,%d\n",mytop3[1][0],mytop3[1][1],mytop3[1][2]);
    printf("%d,%d,%d\n",mytop3[2][0],mytop3[2][1],mytop3[2][2]);
    // printf("%d,%d\n",robotScoreBoard[0][0].info[0].linkNum,robotScoreBoard[0][0].info[0].blockNum);
    // printf("%d,%d\n",robotScoreBoard[0][0].info[1].linkNum,robotScoreBoard[0][0].info[1].blockNum);
    // printf("%d,%d\n",robotScoreBoard[0][0].info[2].linkNum,robotScoreBoard[0][0].info[2].blockNum);
    // printf("%d,%d\n",robotScoreBoard[0][0].info[3].linkNum,robotScoreBoard[0][0].info[3].blockNum);
