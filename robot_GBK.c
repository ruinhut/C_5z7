...
//首先，我们知道，原有的棋盘中是没有禁手的，如果说有，我们在上一次禁手判断就已经是行不通的�?
//所以说，我们只要审判我们新落得这个字他的周边是不是会产生禁手就可以�?
...
//其次，我们需要写一个判度胺落子在哪里的双层搜索，下面的代码主要是为了实现这个目�?
...
//如果有一个点能赢，就直接�?
//如果没有，就根据分数表，模拟敌方思考，选择它的三个最高分的点，然后让他尝试落�?
